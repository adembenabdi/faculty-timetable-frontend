...
export default function AdminTimetablesPage() {
  ...
  const handleAddTimetable = () => {
    ...
    setNewTimetable({ name: "", department: "", level: "", section: "", semester: "", year: "2023-2024" })
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-gray-600">Créer et gérer les emplois du temps</p>
            </div>
          </div>
            ...
            <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
              ...
              <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                  ...
                  <DialogDescription>Définissez les paramètres de base du nouvel emploi du temps.</DialogDescription>
                </DialogHeader>
          ...
          <CardContent className="p-4">
            <div className="flex items-center space-x-4">
              <div className="relative flex-1">
                ...
                <Input
                  placeholder="Rechercher par nom, département ou niveau..."
                  value={searchTerm}
                  ...
                  <TableRow key={timetable.id}>
                    ...
                    <TableCell>
                      <div className="flex items-center space-x-2">
                        <Link
                          href={`/emplois/${timetable.department.toLowerCase()}/${timetable.level.toLowerCase()}/${timetable.section.toLowerCase()}`}
                        >
