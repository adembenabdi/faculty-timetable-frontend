...
// Mock data for the timetable editor
const mockTimetableData = {
  "08:00-09:30": {
    dimanche: { subject: "Architecture", room: "Amphi A", professor: "Dr. Khelifi", type: "Cours" },
    Lundi: { subject: "Mathématiques", room: "Amphi A", professor: "Dr. Benali", type: "Cours" },
    Mardi: null,
    Mercredi: { subject: "Physique", room: "Salle 101", professor: "Dr. Mansouri", type: "TD" },
    Jeudi: null,
    samedi: { subject: "Informatique", room: "Lab Info", professor: "Dr. Khelifi", type: "TP" },
  },
  "09:45-11:15": {
    dimanche: null,
    Lundi: null,
  ...
  "11:30-13:00": {
    ...
    Jeudi: null,
    Vendredi: { subject: "Anglais", room: "Salle 201", professor: "Ms. Smith", type: "TD" },
  },
  "14:00-15:30": {
    Lundi: null,
    Mardi: { subject: "Chimie", room: "Amphi A", professor: "Dr. Amara", type: "Cours" },
    Mercredi: null,
...
const subjects = ["Mathématiques", "Physique", "Informatique", "Chimie", "Anglais", "Architecture"]
const rooms = ["Amphi A", "Amphi B", "Salle 101", "Salle 102", "Salle 103", "Salle 104", "Lab Info", "Lab Physique"]
const professors = ["Dr. Benali", "Dr. Mansouri", "Dr. Khelifi", "Dr. Amara", "Ms. Smith"]
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Grille d'Emploi du Temps</CardTitle>
          </CardHeader>
          <CardContent>
