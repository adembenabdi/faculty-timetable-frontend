  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-gray-600">Gérer tous les professeurs de l'université</p>
            </div>
          </div>
          <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
            ...
            <DialogContent className="sm:max-w-[500px]">
              <DialogHeader>
                ...
                <DialogDescription>Remplissez les informations du nouveau professeur.</DialogDescription>
              </DialogHeader>
              <div className="grid gap-4 py-4">
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setNewProfessor({ ...newProfessor, department: value })}
                  >
        ...
        <Card>
          <CardHeader>
            <CardTitle>Liste des Professeurs ({filteredProfessors.length})</CardTitle>
          </CardHeader>
          <CardContent>
            <Table>
              <TableHeader>
              ...
              <div className="grid gap-4 py-4">
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setSelectedProfessor({ ...selectedProfessor, department: value })}
                  >
                    <SelectTrigger className="col-span-3">
                      <SelectValue />
                    </SelectTrigger>
