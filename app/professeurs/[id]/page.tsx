...
import { ArrowLeft, Download, User, Mail, Phone, Clock, MapPin } from "lucide-react"

// Mock professor data
const professorData: { [key: string]: any } = {
  benali: {
...
export default async function ProfessorTimetablePage({
  ...
  const professor = professorData[id] || professorData["benali"]
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="font-semibold text-sm">{professor.email}</p>
                </div>
              </div>
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="font-semibold text-sm">{professor.phone}</p>
                </div>
              </div>
            </div>
            <div className="mt-4">
              ...
              <div className="flex flex-wrap gap-2">
                {professor.subjects.map((subject: string) => (
